...
{
    public class GetAllNotficationsTableQuery : IRequest<PaginatedResult<NotificationDTO>>
    {
        ...
        public GetAllNotficationsTableQuery(int pageNumber, int pageSize, string searchString, string orderBy)
        {
    ...
    public class GetAllNotficationsTableQueryHandler : IRequestHandler<GetAllNotficationsTableQuery, PaginatedResult<NotificationDTO>>
    {
        private readonly IApplicationDbContext _context;

        public GetAllNotficationsTableQueryHandler(IApplicationDbContext context)
        {
            _context = context ?? throw new ArgumentNullException(nameof(context));
        }

        public async Task<PaginatedResult<NotificationDTO>> Handle(GetAllNotficationsTableQuery request, CancellationToken cancellationToken)
        {
            try
            {
