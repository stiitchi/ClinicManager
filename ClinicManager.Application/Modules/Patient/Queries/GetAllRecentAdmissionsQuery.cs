...
{
    public class GetAllRecentAdmissionsQuery : IRequest<Result<List<PatientDTO>>>
    {
    }

    public class GetAllRecentAdmissionsQueryHandler : IRequestHandler<GetAllRecentAdmissionsQuery, Result<List<PatientDTO>>>
    {
        private readonly IApplicationDbContext _context;

        public GetAllRecentAdmissionsQueryHandler(IApplicationDbContext context)
        {
            _context = context ?? throw new ArgumentNullException(nameof(context));
        }

        public async Task<Result<List<PatientDTO>>> Handle(GetAllRecentAdmissionsQuery request, CancellationToken cancellationToken)
        {
            try
            {
