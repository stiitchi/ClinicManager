...
{ 
    public class GetAllSupportRecordsByPatientIdQuery : IRequest<Result<List<PsychologicalRecordDTO>>>
    {
        public int PatientId { get; set; }
    }

    public class GetAllSupportRecordsByPatientIdQueryHandler : IRequestHandler<GetAllSupportRecordsByPatientIdQuery, Result<List<PsychologicalRecordDTO>>>
    {
        ...
        public async Task<Result<List<PsychologicalRecordDTO>>> Handle(GetAllSupportRecordsByPatientIdQuery request, CancellationToken cancellationToken)
        {
            try
            {
