...
{
    public class GetAllMaskByPatientIdQuery : IRequest<Result<List<OxygenationRecordDTO>>>
    {
        public int PatientId { get; set; }
    }

    public class GetAllMaskByPatientIdQueryHandler : IRequestHandler<GetAllMaskByPatientIdQuery, Result<List<OxygenationRecordDTO>>>
    {
        ...
        public async Task<Result<List<OxygenationRecordDTO>>> Handle(GetAllMaskByPatientIdQuery request, CancellationToken cancellationToken)
        {
            try
            {
