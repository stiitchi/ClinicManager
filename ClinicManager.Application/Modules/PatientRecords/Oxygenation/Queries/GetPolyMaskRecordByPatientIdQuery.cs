...
{
   public class GetPolyMaskRecordByPatientIdQuery : IRequest<Result<List<OxygenationRecordDTO>>>
    {
        public int PatientId { get; set; }
    }

    public class GetPolyMaskRecordByPatientIdQueryHandler : IRequestHandler<GetPolyMaskRecordByPatientIdQuery, Result<List<OxygenationRecordDTO>>>
    {
        ...
        public async Task<Result<List<OxygenationRecordDTO>>> Handle(GetPolyMaskRecordByPatientIdQuery request, CancellationToken cancellationToken)
        {
            try
            {
