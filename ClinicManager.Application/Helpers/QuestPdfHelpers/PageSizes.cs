...
namespace ClinicManager.Application.Helpers.QuestPdfHelpers
{
    public class PageSize
    {
        ...
        public static implicit operator Size(PageSize pageSize) => new Size(Convert.ToInt32(pageSize.Width), Convert.ToInt32(pageSize.Height));
    }
